...
For more information on the full validation pipeline, see the [ValiChord Vision & Architecture](https://www.google.com/search?q=ValiChord_Vision_and_Architecture_8%2520membranes.md) and the [Researcher Support Document](https://www.google.com/search?q=ValiChord_Researcher_Support.md).
