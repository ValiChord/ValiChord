...
Ceri John. I'm not a career software engineer — I build these systems with AI tooling, and say so in the repositories. What I stand behind is the output: the tests, the demo, the independent reproduction, and one rule: every public claim must match what the deployed code does.
