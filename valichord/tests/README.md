...
**Status: 96 pass, 1 skipped, 0 fail** (Tryorama suite; as of 2026-05-09). GoldReproducible covered by sweettest test 15 — see `sweettest_integration/tests/governance.rs`.
